...
public class QRCodeUtil {
	 ...
	 * @return
	 */
	public static byte[] generateQRCodeToByte(String url) {
		try {
			BufferedImage small = QRCodeUtil.encode2(URLDecoder.decode(url,"utf-8"), null, true);
			String filePath = "images/" + "9" + ".jpg";
			BufferedImage finalImage = QRCodeUtil.overlapImage(filePath, small);
			byte[] fimalByte = QRCodeUtil.imageToBytes(finalImage, "jpg");
			return fimalByte;
		} catch (Exception e) {
