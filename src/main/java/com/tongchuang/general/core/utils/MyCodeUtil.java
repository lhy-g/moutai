...
public class MyCodeUtil {
	...
	// 二维码尺寸
	private static final int QRCODE_SIZE = 498;
	// LOGO宽度
	...
	public static byte[] generateQRCodeToEncode2(String content) throws Exception {
		ByteArrayOutputStream out = new ByteArrayOutputStream();
		MyCodeUtil.encode(content, out);
		byte[] fimalByte = out.toByteArray();
		return fimalByte;
...
//				int y = (big.getHeight()-small.getHeight()/2)-30;            
			...
			int y = (big.getHeight() - small.getHeight())- 240;
